...
Sage.ClientEntityContextService.prototype.getContext=function(){var dataelem=$get("__EntityContext");if(dataelem){if(dataelem.value!=""){var obj=dataelem.value.replace(/\n/g," ").replace(/\r/g," ");return eval(obj);}}
