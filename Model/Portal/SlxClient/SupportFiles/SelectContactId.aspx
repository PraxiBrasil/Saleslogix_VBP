    ...
    <script type="text/javascript">
        ...
        function HandleClose(cancel) {
            if (!cancel) {
                var sResult = "";
                var oLookup = null;
                if (typeof SelectedContact_luobj != "undefined") {
                    oLookup = SelectedContact_luobj;
                }
                if (typeof SelectedOppContact_luobj != "undefined") {
                    oLookup = SelectedOppContact_luobj;
                }
                if (oLookup != null) {
        ...
        Ext.onReady(function() {
            var initFunction = function() {
                ...
                if (oLookup != null) {
                    oLookup.show();
                    oLookup.getDialog().buttons[ID_OK].on("click", function(e) { HandleClose(false); });
                    oLookup.getDialog().buttons[ID_CANCEL].on("click", function(e) { HandleClose(true); });
                    var oGrid = oLookup.getGrid();
                    if (oGrid != null) {
                        var oNativeGrid = oGrid.getNativeGrid();
                        if (oNativeGrid != null) {
